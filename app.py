...
if 'Close' not in data.columns:
    st.error("Errore: la colonna 'Close' non esiste nei dati scaricati.")
    st.write("Ecco le colonne presenti:", data.columns)
    st.stop()

if data['Close'].isnull().all():
    st.error("Errore: la colonna 'Close' contiene solo valori nulli.")
